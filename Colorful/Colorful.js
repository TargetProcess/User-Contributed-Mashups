tau.mashups
    ...
    .addMashup(function(topMenu) {
        ...
        var initColorfulTheme = function() {
            ...
            addCSSRule('.tau-list-epic .tau-entity-full-name, .tau-card-v2_type_epic .tau-entity-full-name','color: #00BEA0 !important; font-weight: 600 !important; font-size: 11px;');
			addCSSRule('.tau-list-bug .tau-entity-full-name, .tau-card-v2_type_bug .tau-entity-full-name','color: #E65C5C !important; font-weight: 600 !important; font-size: 11px;');
			addCSSRule('.tau-list-task .tau-entity-full-name, .tau-card-v2_type_task .tau-entity-full-name','color: #66C !important; font-weight: 600 !important; font-size: 11px;');
			addCSSRule('.tau-list-userstory .tau-entity-full-name, .tau-card-v2_type_userstory .tau-entity-full-name','color: #2E8AE5 !important; font-weight: 600 !important; font-size: 11px;');
			addCSSRule('.tau-list-feature .tau-entity-full-name, .tau-card-v2_type_feature .tau-entity-full-name','color: #33991F !important; font-weight: 600 !important; font-size: 11px;');
			addCSSRule('.tau-list-request .tau-entity-full-name, .tau-card-v2_type_request .tau-entity-full-name','color: #d69e38 !important; font-weight: 600 !important; font-size: 11px;');
			// Colorize user names
